...
serve(async (req) => {
  ...
  if (type === "summary") {
      ...
      systemPrompt = `You are a professional resume writer. Generate exactly 4 bullet points for a resume project description. Each bullet must be around 10 words and start with a strong action verb. Describe key features, technologies used, and the problem solved. Do NOT invent specific metrics or percentages. Use the • character to separate bullets. Output ONLY the bullet points.`;
